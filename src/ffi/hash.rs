...
pub unsafe extern "C" fn lustro_hash256_many(
    ...
    let out_blocks: &mut [[u8; 32]] = std::slice::from_raw_parts_mut(out_ptr as *mut [u8; 32], n);
...
pub unsafe extern "C" fn lustro_hash128_many(
    ...
    let out_blocks: &mut [[u8; 16]] = std::slice::from_raw_parts_mut(out_ptr as *mut [u8; 16], n);
